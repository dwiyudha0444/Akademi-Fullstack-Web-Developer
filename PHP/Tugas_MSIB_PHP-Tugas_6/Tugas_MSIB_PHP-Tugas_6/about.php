...
<section id="about" class="about">
    <div class="container mt-4" data-aos="fade-up">
        ...
        <div class="section-title">
            <h2>About</h2>
            <p>Perkenalkan nama saya Dwi Yudha Saputra bisa dipanggil yudha. saya tinggal di jawa tengah tepatnya
                dikudus . saya baru semester 5 di UNIVERSITAS MURIA KUDUS</p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pt-4 pt-lg-0 content">
                ...
                <p class="fst-italic">
                    Saya berkeinginan untuk menjadi seorang pemerogramer yang handal
                </p>
                <div class="row">
                    <div class="col-lg-6">
                        <ul>
                            <li><i class="bi bi-rounded-right"></i> <strong>Birthday:</strong> 25 Desember 2000</li>
                            <li><i class="bi bi-rounded-right"></i> <strong>Website:</strong> www.example.com</li>
                            <li><i class="bi bi-rounded-right"></i> <strong>Phone:</strong> 0895392073353</li>
                            <li><i class="bi bi-rounded-right"></i> <strong>City:</strong> City : Kudus, Jawa Tengah
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
